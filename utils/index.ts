 ...
 * Anyway, this function converts Animated.Value to an integer.
 * @param value Animated.Value
 * @returns A stringified and then parsed integer of parameter `value`.
 */
export function ConvertAnimatedValueToNumber(value: Animated.Value) {
  return Number.parseInt(JSON.stringify(value), 10);
}
